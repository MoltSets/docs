...
Enter the endpoint URL for the MoltSets tool you want to use. Find the correct URL on the tool's API reference page. Not sure which tool you need? See [I Have X, I Want Y](developer-docs/use-cases/i-have-x-i-want-y).
...
- [I Have X, I Want Y](developer-docs/use-cases/i-have-x-i-want-y) — find the right tool based on your input data
