...
| **Plan** | **Enrichment Rate Limit** | **Search Rate Limit** |
| :-- | :-- |
| $0 | 1k requests per minute & 1k results per day | 0 results per day |
| $27 / month | 30 requests per minute & 1k results per day | 500 results per day |
| $97 / month | 1k requests per minute & 15k results per day | 5k results per day |
| \$497 / month (reg. \$997) | 5k requests per minute & 100k results per day | 50k results per day |
