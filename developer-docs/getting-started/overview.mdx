...
| \$497 / month (reg. $997) | Unlimited | 5000 requests/min | 2500 / month |
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/developer-docs/getting-started/authentication">
    Get your API key and learn how to authenticate requests.
  </Card>
  <Card title="Rate Limits" icon="gauge" href="/developer-docs/getting-started/rate-limits">
