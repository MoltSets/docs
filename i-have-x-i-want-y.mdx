...
| LinkedIn slug or URL | Best available email (business preferred, falls back to personal) | "Find the best email for linkedin.com/in/retentionadam" | `enrich_email` |
| LinkedIn slug or URL | Business email only | "Find the business email for linkedin.com/in/retentionadam" | `enrich_business_email` |
...
Use `linkedin_slug_search` to get their LinkedIn slug, then pass it to `enrich_business_email`, `enrich_phone`, or `linkedin_to_business_profile`.
